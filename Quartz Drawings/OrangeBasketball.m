...
#import "OrangeBasketball.h"

@implementation orangeBasketball
...
- (void)drawRect:(CGRect)rect
{
    ...
    CGFloat components[8] = { 252.0/255.0, 162.0/255.0, 5.0/255.0, 1.0,  // Start color
        147.0/255.0, 95.0/255.0, 2.0/255.0, 1.0}; // End color
